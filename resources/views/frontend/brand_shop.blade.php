    ...
    <div class="collection-header">
        <div class="collection-hero">
            ...
            <div class="collection-hero__title-wrapper">
                    <h1 class="collection-hero__title page-width" style="font-size: 45px">{{$brand_name->name}}</h1>
                        ...
                        <div class="row">
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        <!-- start product image -->
                                        <a href="{{route('detail',$brand_item->id)}}">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload" data-src="{{asset('storage/'.$brand_item->photo)}}" src="{{asset('storage/'.$brand_item->photo)}}" alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="{{asset('storage/'.$brand_item->photo)}}" src="{{asset('storage/'.$brand_item->photo)}}" alt="image" title="product" />
                                            <!-- End hover image -->
                                            <!-- product label -->
                                        ...
                                        <form class="variants add" action="#" method="">
                                            <button class="btn btn-addto-cart addtocartBtn" type="button" data-id="{{$brand_item->id}}" data-name="{{$brand_item->name}}" data-price="{{$brand_item->price}}" 
                                                data-discount="{{$brand_item->discount}}" data-photo="{{$brand_item->photo}}" data-codeno="{{$brand_item->codeno}}">Add to Cart</button>
                                        </form>
                                    ...
                                    <div class="product-details text-center">
                                        ...
                                        <div class="product-name">
                                            <a href="#">{{$brand_item->name}}</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                                            @if($brand_item->discount)
                                            <span class="old-price">${{$brand_item->price}}</span>
                                            <span class="price">${{$brand_item->discount}}</span>
                                            @else
                                            <span class="price">${{$brand_item->price}}</span>
                                            @endif
                                        </div>
                                        <!-- End product price -->
