    ...
    <div class="collection-header">
        <div class="collection-hero">
            ...
            <div class="collection-hero__title-wrapper">
                    <h1 class="collection-hero__title page-width" style="font-size: 45px">All Products</h1>
                        ...
                        <div class="row">
                            ...
                            @if(!$search_data->isEmpty())
                                @foreach($search_data as $searchdata)
                                    <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                        ...
                                        <div class="product-image">
                                            <!-- start product image -->
                                            <a href="{{route('detail',$searchdata->id)}}">
                                                <!-- image -->
                                                <img class="primary blur-up lazyload" data-src="{{asset('storage/'.$searchdata->photo)}}" src="{{asset('storage/'.$searchdata->photo)}}" alt="image" title="product" />
                                                <!-- End image -->
                                                <!-- Hover image -->
                                                <img class="hover blur-up lazyload" data-src="{{asset('storage/'.$searchdata->photo)}}" src="{{asset('storage/'.$searchdata->photo)}}" alt="image" title="product" />
                                                <!-- End hover image -->
                                                <!-- product label -->
                                            ...
                                            <form class="variants add" action="#" method="">
                                                <button class="btn btn-addto-cart addtocartBtn" type="button" data-id="{{$searchdata->id}}" data-name="{{$searchdata->name}}" data-price="{{$searchdata->price}}" 
                                                    data-discount="{{$searchdata->discount}}" data-photo="{{$searchdata->photo}}" data-codeno="{{$searchdata->codeno}}">Add to Cart</button>
                                            </form>
                                        ...
                                        <div class="product-details text-center">
                                            ...
                                            <div class="product-name">
                                                <a href="#">{{$searchdata->name}}</a>
                                            </div>
                                            <!-- End product name -->
                                            <!-- product price -->
                                            <div class="product-price">
                                                @if($searchdata->discount)
                                                <span class="old-price">${{$searchdata->price}}</span>
                                                <span class="price">${{$searchdata->discount}}</span>
                                                @else
                                                <span class="price">${{$searchdata->price}}</span>
                                                @endif
                                            </div>
                                            <!-- End product price -->
                                ...
                                <div class="col-12 text-center pt-5">
                                    <p class="text-muted display-4">It's not found</p>
                                </div>
                                @endif
                            @else
