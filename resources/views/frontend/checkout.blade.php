                    ...
                    <div class="your-payment">
                        ...
                        <div class="payment-method">
                            ...
                            <div class="order-button-payment">
                                <button class="btn checkoutbtn" value="Place order" type="submit" data-total="0">Place order</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" src="{{ asset('frontend/checkout.js') }}"></script>
