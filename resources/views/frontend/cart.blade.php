...
<div id="page-content">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col cart style2">
                ...
                {{-- <form action="#" method="post" class="cart style2"> --}}
                    <table>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="3" class="text-left"><a href="{{route('index')}}" class="btn btn-secondary btn--small cart-continue">Continue shopping</a></td>
                                <td colspan="3" class="text-right">
                                    <button type="submit" name="clear" class="btn btn-secondary btn--small  small--hide clearbtn checkout">Clear Cart</button>
                                    <button type="submit" name="update" class="btn btn-secondary btn--small cart-continue ml-2 checkout">Update Cart</button>
                                </td>
                            </tr>
                        </tfoot>
                </table> 
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-4 col-lg-4 cart__footer">
                        <div class="solid-border">	
                          ...
                          <div class="row border-bottom pb-2 pt-2 for_subtotal">
...
<div class="row mt-5 noneshoppingcart_div text-center">
  ...
  <div class="col-12 mt-5 ">
      <a href="{{route('index')}}" class="btn btn-secondary mainfullbtncolor px-3" > 
