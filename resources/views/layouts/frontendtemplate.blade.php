...
<div class="pageWrapper">
	...
	<div class="search">
        ...
        <div class="search__form">
            <form class="search-bar__form" action="{{route('shops')}}" method="GET">
              @csrf
                <button class="go-btn search__button" type="submit"><i class="icon anm anm-search-l"></i></button>
                <input class="search__input" type="search" name="search" id="search" value="" placeholder="Search entire store..." aria-label="Search" autocomplete="off">
            </form>
            <button type="button" class="search-trigger close-btn"><i class="anm anm-times-l"></i></button>
            
        </div>
        <hr>
        <div class="pl-5 ml-5 for_searchdata">
          <ul class="result_data" style="list-style-type: none">
    ...
    <div class="top-header">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-2 col-sm-4 col-md-3 col-lg-4 text-right" id="for_dropdown">
    ...
    <div class="header-wrap animated d-flex border-bottom">
    	<div class="container-fluid">        
            <div class="row align-items-center">
                ...
                <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                	...
                	<nav class="grid__item" id="AccessibleNav"><!-- for mobile -->
                        <ul id="siteNav" class="site-nav medium center hidearrow">
                            <li class="lvl1 parent megamenu"><a href="{{route('index')}}">Home <i class="anm anm-angle-down-l"></i></a>
                            </li>
                            <li class="lvl1 parent megamenu"><a href="{{route('shops')}}">Shop <i class="anm anm-angle-down-l"></i></a>
                            </li>
                        
                            <li class="lvl1 parent dropdown"><a href="#">Merchants <i class="anm anm-angle-down-l"></i></a>
                              <ul class="dropdown">
                                @foreach($brands as $brand)
                                <li><a href="{{route('brand_shop',$brand->id)}}" class="site-nav">{{$brand->name}}</a></li>
                                @endforeach
                              </ul>
                            </li>
                            ...
                            <li class="lvl1 parent dropdown"><a href="#">Categories <i class="anm anm-angle-down-l"></i></a>
                              <ul class="dropdown">
                                ...
                                <li><a href="#" class="site-nav">{{$category->name}} <i class="anm anm-angle-right-l"></i></a>
                                    <ul class="dropdown">
                                      @foreach($subcategories as $subcategory)
                                        @if($category->id == $subcategory->category_id)
                                        <li><a href="{{route('shop',$subcategory->id)}}" class="site-nav">{{$subcategory->name}}</a></li>
                                        @endif
                                      @endforeach
                                    </ul>
                                </li>
                            ...
                            <li class="lvl1 parent megamenu"><a href="{{route('contact')}}">Contact Us <i class="anm anm-angle-down-l"></i></a>
                            </li>
                ...
                <!--Mobile Logo-->
                <div class="col-4 col-sm-3 col-md-3 col-lg-2 pr-5">
                	<div class="site-cart">
                    	<a href="{{ route('cart') }}" class="for_cart" title="Cart">
                        	<i class="icon anm anm-bag-l"></i>
                            <span id="CartCount" class="site-header__cart-count cartNoti" data-cart-render="item_count">0</span>
                            <span class="site-header__cart-total cartTotal">0</span>
                        </a>
